...
//                holder.TVtaskContent.setTextColor(Color.BLACK);
                holder.CBtaskFinish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbDataUtils.addDBData(mContext, taskContent, taskTime, 2);
            ...
            if (mCursorTasked.moveToPosition(position-mCursorTask.getCount())){
                final String taskContent= mCursorTasked.getString(mCursorTasked.getColumnIndex(DBContruct.TaskedDataEntry.COLUMN_TASKED_DATA_STRING));
                final String taskTime = mCursorTasked.getString(mCursorTasked.getColumnIndex(DBContruct.TaskedDataEntry.COLUMN_TIMED_DATA_STRING));
                final long taskId = mCursorTasked.getLong(mCursorTasked.getColumnIndex(DBContruct.TaskedDataEntry._ID));
                holder.TVtaskContent.setText(taskContent);
                ...
                holder.CBtaskFinish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbDataUtils.addDBData(mContext, taskContent, taskTime, 1);
